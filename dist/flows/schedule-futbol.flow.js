...
exports.flowScheduleFutbol = void 0;
...
const PROMPT_SCHEDULE_FUTBOL = `Como ingeniero de inteligencia artificial especializado en la programación de reservas para cancha de futbol,
...
const flowScheduleFutbol = (0, bot_1.addKeyword)(bot_1.EVENTS.ACTION).addAction((ctx_1, _a) => __awaiter(void 0, [ctx_1, _a], void 0, function* (ctx, { extensions, state, flowDynamic }) {
    const ai = extensions.ai;
    const history = (0, handleHistory_1.getHistoryParse)(state);
    const list = yield (0, calendar_1.getCurrentCalendar)(2);
    ...
    yield state.update({ interest: "Reserva futbol", idParent: 2 });
    for (const chunk of chunks) {
        yield flowDynamic([{ body: chunk.trim(), delay: (0, generateTimer_1.generateTimer)(150, 250) }]);
    }
}));
exports.flowScheduleFutbol = flowScheduleFutbol;
