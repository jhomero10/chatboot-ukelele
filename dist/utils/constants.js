...
exports.getCalendar = exports.calendarVoley = exports.calendarsFutbol = void 0;
exports.calendarsFutbol = [{
        "id": "08d1e584fc6684c36d3a5f85d2c3887454579c366adf1c7276f467ca645ca60f", "name": "cancha sintetica"
    }];
exports.calendarVoley = [{
...
const getCalendar = (calendar) => calendar.map((item) => `- ID: ${item.id}  nombre: ${item.name} `).join("\n");
